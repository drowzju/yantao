...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  KbWriteTodosArgs: 'wire writeTodos request is owned by packages/api/yantao-kb-controller/README.md',
  KbWriteTodosResult: 'wire writeTodos result is owned by packages/api/yantao-kb-controller/README.md',
  KbMailMessage: 'wire mail message is owned by packages/api/yantao-kb-controller/README.md',
  KbMailFetchArgs: 'wire mailFetch request is owned by packages/api/yantao-kb-controller/README.md',
  KbMailFetchResult: 'wire mailFetch result is owned by packages/api/yantao-kb-controller/README.md',
  KbMailMarkReadArgs: 'wire mailMarkRead request is owned by packages/api/yantao-kb-controller/README.md',
  KbMailMarkReadResult: 'wire mailMarkRead result is owned by packages/api/yantao-kb-controller/README.md',
  KbRegisterResourceArgs: 'wire registerResource request is owned by packages/api/yantao-kb-controller/README.md',
  KbRegisterResourceResult: 'wire registerResource result is owned by packages/api/yantao-kb-controller/README.md',
  KbExtractArgs: 'wire extractResource request is owned by packages/api/yantao-kb-controller/README.md',
  KbExtractResult: 'wire extractResource result is owned by packages/api/yantao-kb-controller/README.md',
  KbCapabilityArtifact: 'wire capability artifact is owned by packages/api/yantao-kb-controller/README.md',
  KbCapabilityRunArgs: 'wire capabilityRun request is owned by packages/api/yantao-kb-controller/README.md',
  KbCapabilityRunResult: 'wire capabilityRun result is owned by packages/api/yantao-kb-controller/README.md',
  KbCapabilitySummary: 'wire capabilityList row is owned by packages/api/yantao-kb-controller/README.md',
  KbCapabilityListResult: 'wire capabilityList result is owned by packages/api/yantao-kb-controller/README.md',
  ...
  KbCapabilityRegisterArgs: 'wire capabilityRegister request is owned by packages/api/yantao-kb-controller/README.md',
  KbCapabilityRegisterResult: 'wire capabilityRegister result is owned by packages/api/yantao-kb-controller/README.md',
