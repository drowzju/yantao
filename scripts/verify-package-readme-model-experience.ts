...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/yantao': { kind: 'indirect', reason: 'The bundle is a patch-list carrier; the provider route and default-model rows it configures are owned by dsh-llm-pi-ai and dsh-agent-default-model.' },
