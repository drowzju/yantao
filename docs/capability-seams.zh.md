...
| `ctx.yantaoKbController` | `core` | [`api-yantao-kb-controller`](../packages/api/yantao-kb-controller) | - | [`client-ui-yantao`](../packages/client/ui-yantao) | - | 拥有受 kbRoot 约束的 tree/read/write 通道，工作台 UI 经由生成的 yantaoKb Remote 命名空间使用。 |
