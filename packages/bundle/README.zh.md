...
| [`yantao`](yantao/README.md) | yantao headless profile 的内网 GLM 网关提供方层 | —（仅 patch） |
| [`yantao-web-app`](yantao-web-app/README.md) | 基于 base + yantao 的 yantao 工作台浏览器表层（stock dist、KB roster） | 挂载 Web 配置项 |
