...
import yantaoKbRemote from '@deepseek-ai/dsh-api-yantao-kb-controller/remote'
...
export type {} from '@deepseek-ai/dsh-api-yantao-kb-controller/remote'
export type * from '@deepseek-ai/dsh-api-yantao-kb-controller/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, workspaceRemote, yantaoKbRemote,
    ]) {
