...
| [`yantao-kb-controller/`](yantao-kb-controller/README.md) | Owns the yantao workbench UI's kbRoot-confined KB tree/read/write channel. | `ctx.yantaoKbController` / `ctx.remote.yantaoKb` |
