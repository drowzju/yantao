...
| [`yantao-kb-controller/`](yantao-kb-controller/README.zh.md) | 拥有 yantao 工作台 UI 限制在 kbRoot 内的知识库 tree/read/write 通道。 | `ctx.yantaoKbController` / `ctx.remote.yantaoKb` |
