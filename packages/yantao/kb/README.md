...
Fixed schema cost for the seven tools, plus one compact result per call; the `kb_read_entity` result is data-dependent (an entity file's full text) and unbounded by this package.
